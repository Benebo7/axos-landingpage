...
const DatabaseWithRestApi = memo(({
  className,
  circleText,
  badgeTexts,
  buttonTexts,
    ...
    >
      ...
      >
        ...
        <defs>
          ...
          <radialGradient id="db-purple-grad" fx="1">
            {/* Use CSS variables directly so SSR is safe; lightColor can override */}
            <stop offset="0%" stopColor={lightColor || 'hsl(var(--axos-purple))'} />
            <stop offset="50%" stopColor={lightColor || 'hsl(var(--axos-purple-2))'} />
      ...
      <div className="absolute bottom-10 flex w-full flex-col items-center">
        ...
        <div className="relative z-10 flex h-[150px] w-full items-center justify-center overflow-hidden rounded-lg border bg-background shadow-md">
          ...
          {/* Circles (CSS animations instead of framer-motion) */}
          <div
            className="absolute -bottom-14 h-[100px] w-[100px] rounded-full border-t bg-accent/5"
            style={{ animation: "pulseScaleA 2s ease-in-out infinite", transformOrigin: "50% 50%" }}
          />
          <div
            className="absolute -bottom-20 h-[145px] w-[145px] rounded-full border-t bg-accent/5"
            style={{ animation: "pulseScaleB 2s ease-in-out infinite", transformOrigin: "50% 50%" }}
          />
          <div
...
DatabaseWithRestApi.displayName = 'DatabaseWithRestApi';
